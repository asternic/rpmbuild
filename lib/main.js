    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (var line of data.split('\n')) {
                ...
                if(/^Name/.exec(lineArray[0])) {    
                    name = name + lineArray[1];
                }
                if(/^Version/.exec(lineArray[0])) {
            ...
            yield exec.exec(`find /github/workspace/build/4.0/files -type f -exec cp {} /github/home/rpmbuild/SOURCES/ \;`);
            yield exec.exec(`find /github/workspace/build/4.0/patches -type f -exec cp {} /github/home/rpmbuild/SOURCES/ \;`);
            yield exec.exec(`ls -la /github/home/rpmbuild/SOURCES/`);
            //yield exec.exec(`cp /github/workspace/build/4.0/patches/* /github/home/rpmbuild/SOURCES/`);
