...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            await io.cp('/github/workspace/build/4.0/files/*','/github/home/rpmbuild/SOURCES/',options);
            //yield exec.exec(`cp /github/workspace/build/4.0/files/* /github/home/rpmbuild/SOURCES/`);
